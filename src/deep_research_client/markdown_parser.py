"""Parse research markdown files with YAML frontmatter.

This module provides utilities for parsing markdown files that were generated
by deep-research-client, extracting frontmatter metadata and converting them
to a format suitable for browser generation.
"""
